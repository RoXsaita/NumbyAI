...
SAVE_STATEMENT_SUMMARY_DESCRIPTION = textwrap.dedent("""
    ...
    STATEMENT INSIGHTS FORMAT:
    Generate insights in this exact structure:

    ## At a Glance
    [Single concise paragraph: overall summary of the statement period, total inflows/outflows,
    net position, and most notable spending categories. Keep to 2-4 sentences.]

    ## Category Insights
    For each material category (sorted by absolute amount, top 5-7 categories):

    ### [Category Name] - [Total Amount with Currency]
